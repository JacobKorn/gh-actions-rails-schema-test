...
ActiveRecord::Schema[7.0].define(version: 2022_06_03_043624) do
  create_table "hobbies", charset: "utf8mb4", force: :cascade do |t|
    t.string "name"
    t.integer "funness"
  ...
  create_table "person_hobbies", charset: "utf8mb4", force: :cascade do |t|
